...
oBCC$Instituto <- gsub("Periodismo", "ICSA", oBCC$Instituto)
oBCC$Instituto <- gsub("Derecho", "ICSA", oBCC$Instituto)
...
write.csv(oBCC, "C:/Users/G50/Desktop/SRBCC/SRBCC/Clean_Datasets/historial_clean.csv")
...
oBCC %>% glimpse()  %>% View()
  ...
  #Cambia la seccion idioma a ENGLISH
    ...
    oBCC <- oBCC[!grepl("albanian", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("czech-iso8859_2", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("dutch", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("german", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("indonesian", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("malay", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("middle_english", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("slovenian-ascii", oBCC$language_reference),]
    oBCC <- oBCC[!grepl("ukrainian-koi8_r", oBCC$language_reference),]
    
    
    
    oBCC %>% count(language_reference)
    
    oBCC$ISBN <- as.numeric(oBCC$ISBN) 
    oBCC$`Matricula ficticia` <- as.numeric(oBCC$`Matricula ficticia`)  
    str(oBCC)  
str(oBCC)
