...
#instituto <- function(x){
 # oBCC$Instituto <- gsub(x, "IIT", oBCC$Instituto)
#}

#instituto("Ingeniería en Sistemas Automotrices")
#instituto
...
spanish <- oBCC %>% 
  filter(language_reference == "spanish")
    write.csv(spanish, "Historial_English.Spanish/historial_spanish.csv")
    
english <- oBCC %>%
  filter(language_reference == "english")
    write.csv(english, "Historial_English.Spanish/historial_english.csv")
```
